...
class Button:
    ...
    def draw(self):
        ...
        if self.hovered:
            ...
            self.surf.blit(cfg.FONT_CFG[1].render(self.text, True, cfg.BISQUE), (text_centralized.xAxis(), text_centralized.yAxis()))
        else:
            self.surf.blit(self.asset, (self.asset_pos_x, self.asset_pos_y))
            self.surf.blit(cfg.FONT_CFG[1].render(self.text, True, cfg.DARKBROWN), (text_centralized.xAxis(), text_centralized.yAxis()))
